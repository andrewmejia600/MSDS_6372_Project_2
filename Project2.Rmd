...
main.logr_l_3 = glm(Class ~ duration + job + education + month,data=Bank_mrkt_data_partition_train ,family=binomial(link='logit'))

main.logr_l_3$aic

hoslem.test(main.logr_l_3$y, fitted(logr.model.complex), g=10)
plot(main.logr_l_3)
...
#validation against test train split
...
logr.model.complex = glm(Class ~ duration + job + education + month + duration:education + duration:job ,data=Bank_mrkt_data_partition_train ,family=binomial(link='logit'))
step(main.logr_l_3,
     scope = list(upper=logr.model.complex),
     direction="forward",
     test="Chisq",
...
Bank_mrkt_data_partition_formula = as.formula(Class ~ duration + job + education + month)
